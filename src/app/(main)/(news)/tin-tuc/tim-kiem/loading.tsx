export default function Loading() {
  return (
    <div className="px-7 xl:px-32 mx-auto animate-pulse pb-5">
      <div role="status" className="md:block pt-5 max-w-sm ">
      ...
      <div className="pt-5 ">
        <div className="lg:flex lg:flex-row ">
            ...
            <div className="  flex flex-row py-5">
              <div className="basis-1/3 px-1 md:px-3 lg:pl-0">
                <div className="flex items-center justify-center  bg-gray-300 rounded dark:bg-gray-700">
                  <svg
                    className=" text-gray-200 dark:text-gray-600 w-full object-cover object-center  aspect-4/3"
                    aria-hidden="true"
          ...
          <div className="lg:basis-1/4 lg:pl-3 hidden lg:block">
            {/* Danh mục và tin nhiều người đọc */}
            <div className="my-5">
